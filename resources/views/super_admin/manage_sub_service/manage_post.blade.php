        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header bg-white">
                    <p class="card-title">Manage Sub Services</p>
                    <div class="card-description">
                        <a class="btn btn-primary float-right" href="{{route('edit-sub-service')}}">Add New Sub Service</a>
                    </div>
                </div>
                <div class="card-body">
...
$('#get_device_list').DataTable({
    ...
    "pageLength": 10,
    "ajax": {
        "url": ajax_url+'/get-sub-service-list',
        "dataType": "json",
        "type": "POST",
