        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header bg-white">
                    <p class="card-title">Manage Blog Posts</p>
                    <div class="card-description">
                        <a class="btn btn-primary float-right" href="{{route('blog.add-post')}}">Add New Blog Post</a>
                    </div>
                </div>
                <div class="card-body">
...
$('#get_device_list').DataTable({
    ...
    "pageLength": 10,
    "ajax": {
        "url": ajax_url+'/post/get-blog-list',
        "dataType": "json",
        "type": "POST",
...
function update_status(status , id){
    $.ajax({
        type: 'POST',
        url: ajax_url+'/post/update-post-status',
        data: {
            'id': id,
            'status': status,
