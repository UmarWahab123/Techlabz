...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Edit Amazon Deal</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 offset-md-2">
                            <form class="forms-sample" method="post" action="javascript:void(0)" id="add_company">
                                ...
                                <div class="form-group">
                                    <label for="deal">Amazon Deal Code</label>
                                    <textarea class="form-control" name="deal" placeholder="Amazon Deal Code" required rows="5"><?php echo $blog->deal; ?></textarea>
