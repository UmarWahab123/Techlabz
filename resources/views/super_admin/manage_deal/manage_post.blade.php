        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header bg-white">
                    <p class="card-title">Manage Amazon Deals</p>
                    <div class="card-description">
                        <a class="btn btn-primary float-right" href="{{route('add-deal')}}">Add Product</a>
                    </div>
                </div>
                <div class="card-body">
