...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Add New Amazon Deal</p>
                    <div class="card-description pb-5">
                        <a class="btn btn-primary float-right btn-icon-text" href="{{route('manage-deals')}}"> <i class="mdi mdi-arrow-left"></i> Back</a>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-8 offset-md-2">
                            <form class="forms-sample" method="post" action="javascript:void(0)" id="add_company">
                                ...
                                <div class="form-group">
                                    <label for="title">Amazon Deal Code</label>
                                    <textarea class="form-control" name="deal" placeholder="Amazon Deal Code" required rows="5"></textarea>

                                    <span class="deal_error"></span>
                                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.status) {
                               ...
                               window.location.href = ajax_url+"/manage-deals";
