        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header bg-white">
                    <p class="card-title">Manage Brand</p>
                    <div class="card-description">
                        <a class="btn btn-primary float-right" href="{{route('add-brand')}}">Add Brand</a>
                    </div>
                </div>
                <div class="card-body">
...
function update_status(status , id){
    $.ajax({
        type: 'POST',
        url: ajax_url+'/update-brand-status',
        data: {
            'id': id,
            'status': status,
