...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Edit Sub Category</p>
                        ...
                        <div class="col-12 col-md-8 offset-md-2">
                            <form class="forms-sample" method="post" action="javascript:void(0)" id="add_company">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category_id" name="category_id" required>
                                        ...
                                        <?php if($main_service->count() > 0) { 
                                            ...
                                            ?>
                                            <option value="{{@$val->id}}" <?php if(@$val->id == @$blog->service_id) { echo "selected"; } ?>>{{@$val->title}}</option>
                                        <?php } } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="category" name="category" placeholder="Subcategoy Name" value="{{@$blog->title}}"/>
