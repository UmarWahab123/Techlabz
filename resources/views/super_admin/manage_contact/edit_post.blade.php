            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-description pb-5">
                        <a class="btn btn-primary float-right btn-icon-text" href="{{route('manage-contact')}}"> <i class="mdi mdi-arrow-left"></i> Back</a>
                    </div>
                    <div class="row">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response.status) {
                               ...
                               window.location.href = ajax_url+"/manage-contact";
