                    ...
                    <div class="col-lg-3 sidebar-area sidebar-right">
                        <div id="social-links">
                            ...
                            <ul class="styled-icons icon-md icon-dark icon-rounded icon-theme-colored1">
                                <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo route('post', ['slug' => $blog_post->slug]); ?>" class="social-button " id="" target="_blank"><span class="fa fa-facebook-official"></span></a></li>
                                <li><a href="https://twitter.com/intent/tweet?text=<?php echo $blog_post->title; ?>&amp;url=<?php echo route('post', ['slug' => $blog_post->slug]); ?>" class="social-button " id="" target="_blank"><span class="fa fa-twitter"></span></a></li>
                                <li><a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo route('post', ['slug' => $blog_post->slug]); ?>&amp;title=<?php echo $blog_post->title; ?>&amp;summary=<?php echo $blog_post->short_description; ?>" class="social-button " id="" target="_blank"><span class="fa fa-linkedin"></span></a></li>
                                <li><a href="https://wa.me/?text=<?php echo route('post', ['slug' => $blog_post->slug]); ?>" class="social-button " id="" target="_blank"><span class="fa fa-whatsapp"></span></a></li>    
                            </ul>
                        </div>
                        <div id="social-links">
                            <h5>Contact Us</h5>
