            ...
            <div class="section-content">
                <div class="row ">
                    <div class="col-md-12 text-center">
                        <h2 class="title text-white">Brand</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 pb-5">
                        <div class="tm-sc tm-sc-icon-box icon-box icon-top tm-iconbox-icontype-font-icon text-center iconbox-style7-hover-moving-border bg-white iconbox-box-shadow  iconbox-theme-colored1 iconbox-default-padding icon-position-icon-top mb-lg-50" style="box-shadow: 0px 0px 50px  rgb(5 5 5 / 15%);">
                            <div class="icon-box-wrapper">
                                <div class="icon-wrapper"> <a href="<?php echo route('product', ['brand' => $val->slug,'slug' => $slug]); ?>" class="icon icon-type-image icon-default"> <img src="<?php echo url('/public').'/'.$val->image; ?>" alt="Image"> </a></div>
                                <div class="icon-text mt-2">
                                    <h5 class="icon-box-title">{{$val->title}}</h5>
                                    <div class="content">
                                        <div class="tm-sc tm-sc-button mt-2"> 
                                            <a href="<?php echo route('product', ['brand' => $val->slug,'slug' => $slug]); ?>"  class="btn btn-theme-colored1 btn-sm btn-block">View Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
