...
use App\Http\Controllers\RepairServicessController;
...
// Route::get('/new', [HomeController::class, 'index2'])->name('homepage');
...
Route::post('/footer-contact-us', [HomeController::class, 'footer_contact_us'])->name('footer_contact_us');
...
// Repair Services new Design Routs 

Route::get('/repair-services', [RepairServicessController::class, 'repair_services'])->name('repair_services');
Route::get('/repair-services/{type}', [RepairServicessController::class, 'repair_services_category'])->name('repair_services_category');
Route::get('/repair-services/{type}/{slug}/{id}', [RepairServicessController::class, 'repair_services_cat_details'])->name('repair_services_cat_sub_category');
...
Route::group(['middleware' => ['auth','admin']], function() {
    ...
    Route::get('/add-post/{id?}', [DashboardController::class, 'posts'])->name('add-post');
    ...
    Route::get('/delete-post/{id}', [DashboardController::class, 'delete_post'])->name('delete_post');
